...
//			System.out.println(entry.getName());
	...
	public static void forEach(File file, BiConsumer<ZipEntry, InputStream> action) {
		try {
			ZipFile zip = new ZipFile(file);
			forEach(zip, action);
			zip.close();
	...
	public static void forEach(ZipFile zip, BiConsumer<ZipEntry, InputStream> action) {
