...
public class EntityLivingPatch extends ClassTransformer {
  ...
  public void addFields(ClassNode classNode) {
    ...
    FieldNode lastHealthField = new FieldNode(ASMConstants.PSF, "LAST_HEALTH", DataParameter.getDescriptor(), sig, null);
    fields.add(lastHealthField);

    sig = "L" + DataParameter.getClassName() + "<" + NBTTagCompound.getDescriptor() + ">;";
    FieldNode potionWatcher = new FieldNode(ASMConstants.PSF, "POTION_WATCHER", DataParameter.getDescriptor(), sig, null);
  ...
  public void clinit(MethodNode method) {
    ...
    list.getStatic(DataSerializers.getClassName(), DataSerializers.field_187193_c.getName(), DataSerializer.getDescriptor());
    list.invokeStatic(EntityDataManager.getClassName(), EntityDataManager.func_187226_a.getName(), EntityDataManager.func_187226_a.getDescriptor(), false);
    ...
    list.ldc(Type.getType(EntityLivingBase.getDescriptor()));
    list.getStatic(DataSerializers.getClassName(), DataSerializers.field_192734_n.getName(), DataSerializer.getDescriptor());
    list.invokeStatic(EntityDataManager.getClassName(), EntityDataManager.func_187226_a.getName(), EntityDataManager.func_187226_a.getDescriptor(), false);
  ...
  public void entityInit(MethodNode method) {
    ...
    list.getField(EntityLivingBase.getClassName(), Entity.field_70180_af.getName(), EntityDataManager.getDescriptor());
    list.invokeStatic(ZPackage + "/tweaks/EntityTweaks", "entityInit", "(" + EntityDataManager.getDescriptor() + ")V", false);
    list.addToEnd(method);
  }
  ...
  public void setHealth(MethodNode method) {
    ...
    list.var(Opcodes.ALOAD);
    list.dup();
    list.invokeVirtual(EntityLivingBase.getClassName(), EntityLivingBase.func_110143_aJ.getName(), EntityLivingBase.func_110143_aJ.getDescriptor(), false);
  ...
  public void readNbt(MethodNode method) {
    ...
    list.invokeStatic(ZPackage + "/tweaks/EntityTweaks", "readNbt", "(" + EntityLivingBase.getDescriptor() + NBTTagCompound.getDescriptor() + ")V", false);
    list.addToEnd(method);
  ...
  public void writeNBT(MethodNode method) {
    ...
    list.var(Opcodes.ALOAD);
    list.var(Opcodes.ALOAD, 1);
    list.invokeStatic(ZPackage + "/tweaks/EntityTweaks", "writeNbt", "(" + EntityLivingBase.getDescriptor() + NBTTagCompound.getDescriptor() + ")V", false);
    list.addToEnd(method);
    ...
    for (AbstractInsnNode node : method.instructions.toArray()) {
      if (node instanceof FieldInsnNode) {
        ...
        if (fieldNode.desc.equals("Ljava/util/Map;") && node.getNext() instanceof MethodInsnNode) {
          ...
          if (methodNode.name.equals("values") && methodNode.desc.equals("()Ljava/util/Collection;") && methodNode.getNext() instanceof VarInsnNode) {
            VarInsnNode collection = (VarInsnNode) methodNode.getNext();
            int var = collection.var;
            InsnBuilder list = new InsnBuilder();
            list.var(Opcodes.ALOAD);
            list.var(Opcodes.ALOAD, var);
            list.invokeStatic(ZPackage + "/tweaks/EntityTweaks", "updatePotionMetadata", "(" + EntityLivingBase.getDescriptor() + "Ljava/util/Collection;" + ")V", false);
  ...
  public void resetPotionEffectMetadata(MethodNode method) {
    ...
    list.var(Opcodes.ALOAD);
    list.invokeStatic(ZPackage + "/tweaks/EntityTweaks", "resetPotionEffectMetadata", "(" + EntityLivingBase.getDescriptor() + ")V", false);
  ...
  public void notifyDataManagerChange(MethodNode method) {
    ...
    list.var(Opcodes.ALOAD);
    list.var(Opcodes.ALOAD, 1);
    list.invokeStatic(ZPackage + "/tweaks/EntityTweaks", "notifyDataManagerChange", "(" + EntityLivingBase.getDescriptor() + DataParameter.getDescriptor() + ")V", false);
  ...
  public void addGetLastHealth(ClassNode classNode) {
    ...
    list.invokeVirtual(EntityDataManager.getClassName(), EntityDataManager.func_187225_a.getName(), EntityDataManager.func_187225_a.getDescriptor(), false);
    list.checkCastFloat();
    list.floatValue();
  ...
  public void addSetLastHealth(ClassNode classNode) {
    ...
    list.valueOfFloat();
    list.invokeVirtual(EntityDataManager.getClassName(), EntityDataManager.func_187227_b.getName(), EntityDataManager.func_187227_b.getDescriptor(), false);
    list.end();
    list.addTo(getLastHealth);
