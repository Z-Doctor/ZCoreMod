...
public class Bootstrap$3 {
	...
	public static String getClassName() {
		if (CoreModFMLLoadPlugin.isObfuscated)
			...
			return "net/minecraft/init/Bootstrap$3";
	}
	...
	public static String getDescriptor() {
		if (CoreModFMLLoadPlugin.isObfuscated)
			...
			return "Lnet/minecraft/init/Bootstrap$3;";
	}
	 ...
	 * </p>
	 */
	public static McObfPair func_82499_a = McMappingDatabase.getSRG("Bootstrap$3.func_82499_a");
