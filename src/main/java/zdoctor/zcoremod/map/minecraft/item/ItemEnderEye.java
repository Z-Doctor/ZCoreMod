...
public class ItemEnderEye {
	...
	public static String getClassName() {
		if (CoreModFMLLoadPlugin.isObfuscated)
			...
			return "net/minecraft/item/ItemEnderEye";
	}
	...
	public static String getDescriptor() {
		if (CoreModFMLLoadPlugin.isObfuscated)
			...
			return "Lnet/minecraft/item/ItemEnderEye;";
	}
	 ...
	 * </p>
	 */
	public static McObfPair func_77659_a = McMappingDatabase.getSRG("ItemEnderEye.func_77659_a");
	 ...
	 * </p>
	 */
	public static McObfPair func_180614_a = McMappingDatabase.getSRG("ItemEnderEye.func_180614_a");
